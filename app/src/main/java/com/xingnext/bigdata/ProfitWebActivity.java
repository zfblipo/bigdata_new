...
public class ProfitWebActivity extends BaseActivity {

    private TitleHelper titleHelper;
    private WebView profit_web_view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profit_web);
    ...
    private void initView() {
        titleHelper = new TitleHelper(mContext, R.id.profit_web_top, "盈利计划");

        profit_web_view = (WebView) findViewById(R.id.profit_web_view);

        initWeb();
        myDialog.show();

        String url = MyUrl.profitWebUrl+"?token=" + MyStatic.userData.access_token;
        profit_web_view.loadUrl(url);
...
//        pay_web_view.postUrl(url, postDate.getBytes());
        ...
        profit_web_view.setWebViewClient(new WebViewClient() {
            @Override
        ...
        profit_web_view.addJavascriptInterface(new ProfitWebActivity.JsInteration(), "xingnext");
    }

    private void initWeb() {
        WebSettings webSettings = profit_web_view.getSettings();
