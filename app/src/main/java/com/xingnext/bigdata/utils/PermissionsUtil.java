...
public class PermissionsUtil {
	...
	// 状态码、标志位
	  ...
	  private static String[] PERMISSIONS_GROUP = {
	      ...
	      Manifest.permission.SEND_SMS, Manifest.permission.CALL_PHONE,Manifest.permission.READ_PHONE_STATE,
...
//	            snackbar.show();
	  ...
	  public static boolean isAppFirstRun(Activity activity) {
	    SharedPreferences sp = activity.getSharedPreferences("oolock_config", Context.MODE_PRIVATE);
